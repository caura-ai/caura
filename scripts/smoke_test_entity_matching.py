...
CASES = [
    ...
    (
        "Can you find the database config?",
        ["database", "config"],
        ["can", "you", "find"],
    ),
...
for query in ["What is the deployment status?", "art gallery", "started the project"]:
    ...
    for name in ENTITY_NAMES:
        old_tokens = [
            t.lower() for t in query.split() if len(t) >= ENTITY_TOKEN_MIN_LENGTH
        ]
