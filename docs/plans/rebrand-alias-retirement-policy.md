...
- The read-only Cloud Run domain-mapping inventory on 2026-09-09 found no
  legacy sandbox-domain mapping; the only sandbox mapping was
  `sandbox-2.caura.dev`. No S4 alias remains to sunset, and absence is not
  authority to recreate one.
